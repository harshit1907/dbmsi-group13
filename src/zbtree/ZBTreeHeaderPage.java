 ...
 */
public class ZBTreeHeaderPage extends NHFPage {
    ...
    public ZBTreeHeaderPage(PageId pageno) throws ConstructPageException {
        super();
        try {
    ...
    public ZBTreeHeaderPage(Page page) {
        super(page);
    }

    public ZBTreeHeaderPage( ) throws ConstructPageException {
        super();
        try{
            Page apage = new Page();
