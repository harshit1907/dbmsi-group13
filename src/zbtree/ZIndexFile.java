...
public abstract class ZIndexFile
{
   ...
   * @param nid the rid of the tuple with the key
  ...
  abstract public void insert(final KeyClass data, final NID nid)
		  ...
		  LeafDeleteException,
		  InsertException,
		  IOException, DescriptorNotMatchException, LeafInsertDescException, IndexInsertDescException, DeleteDescException;

  /**
   * Delete entry from the index file.
   * @param data the key for the entry
   * @param nid the nid of the tuple with the key
   * @exception IOException from lower layers
  ...
  abstract public boolean Delete(final KeyClass data, final NID rid)
		  ...
		  DeleteRecException,
		  IndexSearchException,
		  IOException, DeleteDescException, DescriptorNotMatchException, InsertDescException, IndexInsertDescException;
}
