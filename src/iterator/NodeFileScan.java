 ...
 */
public class NodeFileScan extends  Iterator
{
 ...
 * @throws InvalidTypeException 
   */
  public  NodeFileScan (String  file_name,
            AttrType in1[],                
            short s1_sizes[], 
            short     len_in1,              
            int n_out_flds,
    ...
    throw new FileScanException(e, "Create new nodeheapfile failed");
      }
  ...
  public Tuple get_next()
    ...
    {     
      ...
      while(true) {
    if((node1 =  scan.getNext(rid)) == null) {
      return null;
    }
